    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to your ResumeAI Pro account</p>
        </div>
        ...
        <div className="rounded-2xl bg-white border shadow-sm p-6 space-y-3">
          ...
          <Button variant="outline" className="w-full gap-3 h-11" onClick={() => toast({ title: "Coming soon", description: "Email/password auth is being added." })}>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          No account?{" "}
          <Link href="/register" className="font-medium text-blue-600 hover:text-blue-700">Sign up free</Link>
        </p>
      </div>
    </div>
  );
